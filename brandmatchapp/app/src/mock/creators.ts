...
// that found it and, inside that campaign, the agent that brought it in.
//
...
interface Row {
  ...
  signals: Signal[]
  campaign: string
  /** The agent inside that campaign that brought this creator in. */
  agent: string
...
const rows: Row[] = [
  // Three stars. Niche, selling, and a signal in the last 30 days.
  {
    ...
    signals: [sig('sponsored_post', 2), sig('media_kit', 48)], campaign: 'a1', agent: 'g1', seen: 900,
  },
  {
    ...
    signals: [sig('collab_bio', 3)], campaign: 'a1', agent: 'g2', seen: 5,
  },
  {
    ...
    signals: [sig('promoted_supplement', 1), sig('sponsored_post', 41), sig('launched_program', 120)], campaign: 'a2', agent: 'g3', seen: 1_300,
  },
  {
    ...
    signals: [sig('media_kit', 7)], campaign: 'a1', agent: 'g1', seen: 400,
  },
  {
    ...
    signals: [sig('posted_rates', 9), sig('sponsored_post', 66)], campaign: 'a1', agent: 'g2', seen: 2_000,
  },
  {
    ...
    signals: [sig('promoted_supplement', 4), sig('sponsored_post', 74)], campaign: 'a2', agent: 'g3', seen: 3_000,
  },
  {
    ...
    signals: [sig('collab_bio', 6)], campaign: 'a1', agent: 'g1', seen: 3,
  },
  {
    ...
    signals: [sig('launched_merch', 10), sig('media_kit', 95)], campaign: 'a1', agent: 'g2', seen: 4_000,
  },
  ...
  // Two stars. Niche and selling, with the last brand signal older than 30 days or none at all.
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 1_100,
  },
  {
    ...
    signals: [sig('launched_program', 160)], campaign: 'a1', agent: 'g2', seen: 900,
  },
  {
    ...
    signals: [sig('sponsored_post', 8)], campaign: 'a1', agent: 'g1', seen: 5_000,
  },
  {
    ...
    signals: [], campaign: 'a3', agent: 'g4', seen: 1_700,
  },
  {
    ...
    signals: [sig('launched_program', 200)], campaign: 'a1', agent: 'g2', seen: 2_600,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 7,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 500,
  },
  {
    ...
    signals: [sig('sponsored_post', 88)], campaign: 'a1', agent: 'g1', seen: 4_400,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 750,
  },
  {
    ...
    sells: 'an ebook', niche: 0.5,
    nicheWhy: 'Technique content and an ebook, with an audience of women over 40 rather than beginners.',
    signals: [], campaign: 'a3', agent: 'g5', seen: 3_600,
  },
  {
    ...
    signals: [sig('sponsored_post', 140)], campaign: 'a1', agent: 'g1', seen: 4_900,
  },
  {
    ...
    signals: [], campaign: 'a3', agent: 'g4', seen: 1_600,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 1_500,
  },
  ...
  // One star. Niche, selling nothing yet.
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 44,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 300,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 800,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 2_900,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 14,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 1_000,
  },
  {
    ...
    signals: [], campaign: 'a3', agent: 'g5', seen: 2_100,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 5_500,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 52,
  },
  {
    ...
    signals: [], campaign: 'a3', agent: 'g4', seen: 7_000,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 6_200,
  },
  ...
  // Zero stars. Outside the niche.
  {
    ...
    signals: [sig('launched_merch', 3)], campaign: 'a2', agent: 'g3', seen: 600,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g2', seen: 700,
  },
  {
    ...
    signals: [sig('promoted_supplement', 80)], campaign: 'a2', agent: 'g3', seen: 2_200,
  },
  {
    ...
    signals: [sig('sponsored_post', 5), sig('media_kit', 110)], campaign: 'a2', agent: 'g3', seen: 6_000,
  },
  {
    ...
    signals: [], campaign: 'a2', agent: 'g3', seen: 3_300,
  },
  {
    ...
    signals: [], campaign: 'a2', agent: 'g3', seen: 1_900,
  },
  {
    ...
    signals: [], campaign: 'a1', agent: 'g1', seen: 2_400,
  },
  {
    ...
    signals: [], campaign: 'a2', agent: 'g3', seen: 16,
  },
]
