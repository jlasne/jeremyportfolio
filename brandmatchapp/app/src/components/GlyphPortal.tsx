 ...
 *
 * Adapted for this app: no "use client" (Vite, not Next), and `inert` is spread
 * from a typed object because React 18's JSX types have no such prop. Nothing
 * else is changed. The component brings its own CSS and takes its colours from
 * four custom properties, so it needs neither Tailwind nor a component library.
 */
...
/** React 18's JSX types carry no `inert`; the attribute itself is fine. */
