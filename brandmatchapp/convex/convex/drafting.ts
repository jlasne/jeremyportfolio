...
function instructions(): string {
  ...
  return [
    ...
    '',
    'The brief wins over the library everywhere it says something. A library is a starting shape for what the brief leaves out, and nothing more.',
    '  Read who these people are from the brief, never from the library you picked. A brief about comedy sketches, pranks and street interviews is about comedians, whatever the library calls its people.',
    '  Every figure the brief names is the figure you write. "10k to 100k followers" is 10000 and 100000, not the library range.',
    '  Every country and language the brief names goes in the list, not the first one.',
    '',
    ...
    '  The job comes from the brief and never from the library. Asked for comedy sketches and pranks, write "comedy creator" and "prank channel", never "online course creator", whatever the library sells to.',
    ...
    '',
    'Also write a short campaign name, "<who>, <what you sell>", under sixty characters. Who is the brief\'s people, not the library\'s.',
    'Country and language codes: every one the brief names, and the ones a named region implies.',
