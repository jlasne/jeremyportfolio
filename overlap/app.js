...
function renderLink(){
  var c=$("#linkCard"), g=$("#createBtn");
  if(!c||!g) return;
  if(!inMeeting()){
    /* Nothing to invite anybody to yet, so step 2 says what is missing
       rather than showing an empty link box. */
    c.innerHTML='<div class="empty"><b>No link yet.</b>'+
      "Create the meeting in step 1 and the link appears here.</div>";
