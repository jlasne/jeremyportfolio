...
function renderGuests(){
  ...
  var t=sel();
  $("#nextNote").textContent=t
    ? fmtLongDate(t,dispTz())+", "+fmtT(t,dispTz())
    : "no hour taken yet";
}
...
function renderAll(){
  ...
  renderBest(); renderGuests(); renderFeedback(); renderDock();
}
