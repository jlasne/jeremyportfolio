...
function renderPeople(){
  ...
  html+='<div class="row tap" data-share="1"><div class="plus">+</div>'+
        '<div class="grow"><div class="t">Add people</div>'+
        '<div class="s">Send them the link. They answer for themselves.</div>'+
...
function renderDock(){
  ...
  if(!t){
    h.textContent=total<2
      ? "Just you so far. Add people in step 2."
