  ...
  $("#railFoot").innerHTML=
    ...
    (you?'<button class="rail-team" data-signout="1"><span class="avatar">'+esc(initials(you))+"</span>"+
      ...
      :'<a class="rail-team" href="'+b+'/login/"><span class="plus">→</span>'+
       '<span class="rail-tx"><b>Sign in</b><span>Keep this on every device</span></span></a>');
}
function renderAll(){
...
if(LIVE && !token() && location.hash.indexOf("#t=")!==0){
