...
function renderSteps(){
  ...
  /* The dock does step 2 until there is a link, then step 4. Say which,
     or it reads as a 4 sitting over a button that gets you a link. */
  el=$("#dockStep");
  if(el){
    var doing=(LIVE && signedIn() && ready() && !inMeeting()) ? 2 : 4;
    el.textContent=doing;
    el.className="stepn"+(now===doing?" on":" wait");
  }
}
